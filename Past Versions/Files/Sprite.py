...
image_list = [imgPerson, imgPlayerMono]
for u in image_list:
...
imgPlayerStandingLeft = imgPlayerMono[0]
imgPlayerStandingRight = pygame.transform.flip(imgPlayerMono[0], True, False)
imgPlayerStandingUp = imgPlayerMono[7]
imgPlayerStandingDown = imgPlayerMono[12]
...
Calendar = Object(Images.Calendar, 1/2, (400, 400), False)

objList.add(objPerson, Calendar)
spritesList.add(objPerson, Calendar, Player)
